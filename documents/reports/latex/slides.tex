...
%% Sample Output — static worked example, placed at the end of Evaluation Results
%% (no separate ToC entry) right before Conclusion, for narrative flow (2026-07-14).
\input{slides/sections/10_demo.tex}

\section{6. Conclusion}
\input{slides/sections/11_contributions.tex}

\input{slides/sections/15_thankyou.tex}

\input{slides/sections/13_references.tex}

\appendix
%% Demo video placeholder stays cut from the timed main flow — see Backup 4 inside
%% 14_backup.tex. If asked, demo live in Q&A instead (GDEMO-01 in 33-RUN-PLAN.md).
\input{slides/sections/14_backup.tex}
