...
\node[obox] (dc)  at (-6.0, -0.95) {Retained Seeds +\\Controlled Gen.};
\node[obox] (qrv) at (-3.0, -0.95) {Schema +\\Quality Review};
\node[obox] (spl) at ( 0.0, -0.95) {Group-Safe\\Splits};
...
\end{tikzpicture}
\caption{End-to-end system overview: governed dataset construction, two local model families, model packaging, and the explainable local decision layer.}
