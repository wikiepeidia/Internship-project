...
% Department-style chapter headings: blue, uppercase, horizontal rule below
\titleformat{\chapter}[block]
  {\normalfont\Large\bfseries\color{CVBLUE}}
  {}
  {0pt}
  {\MakeUppercase}
  [{\color{CVBLUE}\titlerule[1pt]}]
\titlespacing*{\chapter}{0pt}{-10pt}{14pt}
\titlespacing*{\section}{0pt}{8pt}{4pt}
\titlespacing*{\subsection}{0pt}{6pt}{3pt}

% Department-template Roman section headings (v2.2 — STRUCT-01)
% \refstepcounter{chapter} advances the counter so figure/table numbering
% stays Arabic (e.g., Figure 1.1) without redefining \thechapter globally.
\newcommand{\thesissection}[1]{%
  \refstepcounter{chapter}%
  \chapter*{\Roman{chapter}/ #1}%
  \addcontentsline{toc}{chapter}{\Roman{chapter}/ #1}%
  \markboth{\Roman{chapter}/ #1}{\Roman{chapter}/ #1}%
}
...
\fancyhead[R]{\small Internship Bachelor Thesis}
\fancyfoot[C]{\thepage}
...
% ── Thesis body — six sections (Implementation split out) (v2.2 STRUCT-02) ─
