...
\begin{frame}{Training Pipeline Overview}
  ...
  \begin{beamercolorbox}[wd=.93\textwidth,sep=0.7ex,rounded=true]{block body}
    {\footnotesize\textbf{Data note:} The reported 254 rows are the trainer validation split. Seed overlap with training limits the generalization claim; the 413-row test split remains unevaluated.}
  \end{beamercolorbox}
\end{frame}
