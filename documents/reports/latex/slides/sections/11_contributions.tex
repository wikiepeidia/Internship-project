...
\begin{frame}{Contributions}
  ...
  \begin{block}{Contributions}
    \begin{enumerate}
      ...
      \item \textbf{Privacy-first local runtime:} \texttt{Qwen3-4B-Instruct} GGUF Q8\_0 via \texttt{llama.cpp}; ${\approx}24$\,s in the final laptop CLI smoke test; no cloud inference.
