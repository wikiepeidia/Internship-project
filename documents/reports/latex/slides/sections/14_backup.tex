%% Backup appendix (Phase 33 D-11) — 3 hidden Q&A-only frames, sit after \appendix in slides.tex.
%% Preserves content trimmed during the Motivation+WhyLocal, Evaluation+Confusion, and
%% Contributions+Future merges. Not counted toward the main-frame footline total
%% (\insertmainframenumber freezes the denominator at 11).
