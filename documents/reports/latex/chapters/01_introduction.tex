...
This is a text-only prototype for Vietnamese financial phishing. Image-based phishing such as QR codes and forwarded screenshots, voice calls, deepfake audio, and malware analysis are all out of scope.
