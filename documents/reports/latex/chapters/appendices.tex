...
The layout of the source tree and what each folder does is described in Chapter~IV. One point is worth repeating here: \texttt{src/model\_adaptation} holds the older experiment code. It is kept because the recorded results were produced with it, and it should not be read as the current design.
