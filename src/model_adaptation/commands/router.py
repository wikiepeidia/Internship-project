...
_ROUTE_ROWS = (
    ...
    ("phase40-preflight", "src.model_adaptation.cli", "handle_phase40_preflight"),
    ("phase40-build-source-bundle", "src.model_adaptation.cli", "handle_phase40_build_source_bundle"),
    ("phase40-build-input-bundle", "src.model_adaptation.cli", "handle_phase40_build_input_bundle"),
    ("phase40-verify-input-bundle", "src.model_adaptation.cli", "handle_phase40_verify_input_bundle"),
    ("phase40-verify-run-request", "src.model_adaptation.cli", "handle_phase40_verify_run_request"),
    ("phase40-verify-run-evidence", "src.model_adaptation.cli", "handle_phase40_verify_run_evidence"),
    ("phase40-render-graphs", "src.model_adaptation.cli", "handle_phase40_render_graphs"),
    ("phase40-validate-notebooks", "src.model_adaptation.cli", "handle_phase40_validate_notebooks"),
    ("phase40-finalize-comparison", "src.model_adaptation.cli", "handle_phase40_finalize_comparison"),
    ("phase40-freeze-scope-amendment", "src.model_adaptation.cli", "handle_phase40_freeze_scope_amendment"),
    ("phase40-verify-review-queue", "src.model_adaptation.cli", "handle_phase40_verify_review_queue"),
    ("phase40-finalize-human-review", "src.model_adaptation.cli", "handle_phase40_finalize_human_review"),
