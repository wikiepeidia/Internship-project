...
**Why:** The present source graph has 92 modules, 224 internal edges, and three SCCs: a five-module Phase 40 training/release knot, `phase40_evidence <-> phase40_graphs`, and `phase41_evaluation <-> phase41_protocols`. `src.model_adaptation.cli` has 16 internal outgoing dependencies, and `training` has 12. [VERIFIED: read-only AST import graph, 2026-08-26]
...
2. **How strict is “active import cycle” for historical commands?**
   ...
   - What we know: three SCCs are present, and full rewrites of the largest historical modules are high risk. [VERIFIED: read-only AST graph, 2026-08-26]
